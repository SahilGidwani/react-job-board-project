...
function DeleteJobListingDialog({ deleteListing }) {
  return (
    <AlertDialog>
...
function getJobListingStatus(expiresAt) {
  if (expiresAt == null) {
    return "Draft";
...
function getDaysRemainingText(expiresAt) {
...
function getJobListingBadgeVariant(status) {
  switch (status) {
    case "Draft":
      return "secondary";
    case "Active":
